...
let perfectNumCandidate = a;
let sumOfFactors = 0;

for (let factorCandidate = 0; factorCandidate < a; factorCandidate++) {
    let rem = perfectNumCandidate % factorCandidate;
    if (rem === 0) {
        sumOfFactors += factorCandidate;
    }
    
}

console.log(sumOfFactors === a && a !== 0)
